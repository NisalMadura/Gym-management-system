            ...
            if (!mysqli_stmt_prepare($result, $sql)) {
                ...
                if ($row = mysqli_fetch_assoc($resultl)) {
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                        ...
                        $sql = "INSERT INTO users (username , idcardnumber, useraddress,birthday,phonenumber,userheight,userweight,registerdate, fingerprint_id, fingerprint_select) VALUES (?, ?, ?, ?, ?,?, ?, ?, ?, ?)";
                        $result = mysqli_stmt_init($conn);
                        if (!mysqli_stmt_prepare($result, $sql)) {
                            ...
                            mysqli_stmt_bind_param($result, "sdsi", $Uname, $IdNumber, $Address, $DOB, $Phone ,$Height ,$Weight ,$RegDate );
                            mysqli_stmt_execute($result);
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                        ...
                        mysqli_stmt_bind_param($result, "sdsi", $Uname, $IdNumber, $Address, $DOB, $Phone ,$Height ,$Weight ,$RegDate, $fingerID);
                        mysqli_stmt_execute($result);
